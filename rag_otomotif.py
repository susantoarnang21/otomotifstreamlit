...
# CONFIGURASI HALAMAN
# ===============================
st.set_page_config(page_title="Chatbox Tanya Penjualan Otomotif Indonesia", page_icon="🚗")

st.title("🚗 Chatbox Tanya Penjualan Otomotif Indonesia")
st.write("Gunakan chat ini untuk menanyakan data penjualan mobil di Indonesia berdasarkan data GAIKINDO.")

if not google_api_key:
    st.info("Masukkan Google API Key Anda di the sidebar to start chatting.", icon="🗝️")
    st.stop()
...
def load_pdf_texts_from_github():
    base_url = "https://github.com/susantoarnang21/otomotifstreamlit/tree/main"
...
st.info("📄 Mengambil dan memproses data PDF dari GitHub...")
